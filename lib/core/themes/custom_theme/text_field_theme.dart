...
class ITextFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: WTextTheme.lightTextTheme.bodyMedium,
    hintStyle: WTextTheme.lightTextTheme.bodyMedium,
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    prefixIconColor: Colors.grey,
    suffixIconColor: Colors.grey,
    labelStyle: WTextTheme.darkTextTheme.bodyMedium!.copyWith(color: WColors.white),
    hintStyle: WTextTheme.darkTextTheme.bodyMedium!.copyWith(color: WColors.white),
    errorStyle: const TextStyle().copyWith(fontWeight: FontWeight.normal, color: Colors.red),
    floatingLabelStyle: const TextStyle().copyWith(color: WColors.white.withValues(alpha: 0.8)),
    border: const OutlineInputBorder().copyWith(
      borderRadius: BorderRadius.circular(14),
      borderSide: const BorderSide(width: 1, color: Colors.grey),
    ),
